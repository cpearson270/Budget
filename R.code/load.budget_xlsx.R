...
## REQUIRES: NA
## Project: Budget Tracker PART 2 20230228
## Last update: 
# 21/07/2024 - removed check for category <100 to allow for additional income categories
# 16/04/2022 - added budget version value and removed budget check
...
rm(file_budget, path_budget, df_expense_groups) #check_budget, 
