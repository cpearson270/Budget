#### create.rt_category_lookup1.2
## create list of key words for each category
  # v1.1 - adjusted to include 2 word pairs
  # v1.2 - removes creation of less efficient lookup table option
## REQUIRES: 
